 ...
 * Variant. Content-only -- targeting is never edited from Admin ->
 * Data (that stays Snapshots' domain), and assets are carried over
 * unchanged from the base variant (uploading new/changed assets is
