...
const rotatingItems = [
  { icon: <FaCode className="inline-block mr-2 text-purple-300 dark:text-purple-400" />, text: 'Full-Stack • JavaScript, Python, Node.js, React' },
  ...
  { icon: <FaChartLine className="inline-block mr-2 text-yellow-300 dark:text-yellow-400" />, text: 'Business Intelligence • Tableau, Power BI, MATLAB, Minitab' },
